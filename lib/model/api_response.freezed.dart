...
mixin _$ApiResponse {
  ...
  List<ApiEntry> get entries => throw _privateConstructorUsedError;
...
abstract class $ApiResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({int count, List<ApiEntry> entries});
}
...
class _$ApiResponseImpl implements _ApiResponse {
  const _$ApiResponseImpl(
      {required this.count, required final List<ApiEntry> entries})
      : _entries = entries;
  ...
  @override
  final int count;
  final List<ApiEntry> _entries;
  @override
  List<ApiEntry> get entries {
  ...
  @override
  String toString() {
    return 'ApiResponse(count: $count, entries: $entries)';
  }
...
abstract class _ApiResponse implements ApiResponse {
  const factory _ApiResponse(
      ...
      required final List<ApiEntry> entries}) = _$ApiResponseImpl;
